...
{{--    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Commissioner:wght@200;300;400;500;600;700&amp;family=JetBrains+Mono:ital@0;1&amp;display=swap">--}}
    <link href="{{URL::asset('css/Commissioner-font-css')}}" rel="stylesheet"></link>
...
<body class="text-gray-600">
    ...
    <script src="{{URL::asset('js/mousetrap.min.js')}}"></script>
    <script src="{{URL::asset('js/mousetrap-global-bind.min.js')}}"></script>
